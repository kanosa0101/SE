<template>
  <div class="telemetry-bar">
    ...
    <button class="threshold-button" type="button" @click="$emit('threshold')"><span class="context-dot" />{{ timezone }} / CONTEXT</button>
...
.signal, .context-dot { width: 6px; height: 6px; border-radius: 50%; background: var(--cyan); box-shadow: 0 0 10px rgba(76, 215, 246, .7); }
.context-dot { background: var(--green); box-shadow: 0 0 10px rgba(78, 222, 163, .7); }
